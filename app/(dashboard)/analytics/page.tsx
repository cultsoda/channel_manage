        ...
        <TabsContent value="revenue" className="space-y-6">
            ...
            <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground mt-2">멤버십/단건구매/펀딩/굿즈 별 수익 분석</p>
                </CardContent>
              </Card>
          ...
          <div>
            ...
            <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-5">
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium">펀딩 현황</CardTitle>
                  <Heart className="h-4 w-4 text-muted-foreground" />
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">₩ 210,000</div>
                  <p className="text-xs text-muted-foreground">펀딩 금액 집계</p>
                  <div className="mt-2 space-y-1">
                    <div className="flex justify-between text-xs">
                      <span>총 펀딩 참여자</span>
                      <span>47명</span>
